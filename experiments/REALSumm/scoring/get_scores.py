...
def main(data_path, out_path, metric):
    ...
    print(f"number of refs: {num_lines_ref}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-op", '--output_path', type=str, default='.',
                        help="path at which to store dict with scores", required=False)
